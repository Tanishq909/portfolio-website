        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={mernChatApp}
              title="MERN Chat App"
              description="A full-stack chat application built with the MERN stack, featuring real-time messaging,user authentication, and responsive design. This project showcases the integration of MongoDB, Express, React, and Node.js to create a seamless chat experience."
